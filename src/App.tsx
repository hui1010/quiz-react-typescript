...
import { Difficulty, fetchQuizQuestions, QuestionState } from './apiCalls';
...
function App() {
  ...
  const nextQuestion = () => {
    // Move onto the next queston if not the last question
    const nextQuestion = number + 1
    
    if(nextQuestion === TOTAL_QUESTIONS) {// if we're on the last question
      setGameOver(true)
    } else {
